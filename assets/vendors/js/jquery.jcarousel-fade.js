...
(function ($) {
  ...
  $.jcarousel.fn.fade = function (target, animate, callback) {
    ...
    if (parsedTarget.relative) {
      ...
      nextTarget = $.isNumeric(parsedTarget.target)
        ? this.items().eq(parsedTarget.target)
        : parsedTarget.target;
    }
    ...
    function _animate() {
      ...
      css[instance.lt] =
        (currentTarget.position()[instance.lt] +
          instance.list().position()[instance.lt]) *
          -1 +
        "px";
        ...
        currentTarget
          ...
          .css({
            ...
            transitionTimingFunction:
              transitionsOptions.easing || animationOptions.easing,
